<x-admin.layout>
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-8">
        <div class="max-w-3xl mx-auto px-6">
            ...
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Tambah Kelas</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Tambahkan kelas baru ke dalam sistem</p>
            </div>

            {{-- Form Card --}}
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <form action="{{ route('admin.classrooms.store') }}" method="POST" class="p-8">
                    @csrf

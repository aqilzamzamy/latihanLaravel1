<x-admin.layout>
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-8">
        <div class="max-w-3xl mx-auto px-6">
            ...
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Tambah Guru</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Tambahkan data guru baru ke sistem</p>
            </div>
